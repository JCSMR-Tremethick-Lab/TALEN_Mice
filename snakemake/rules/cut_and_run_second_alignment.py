...
rule bowtie2_pe_spikeIn:
    ...
    output:
        protected("{assayType}/bowtie2/{spikein_version}/{runID}/{library}.spikeIn.bam")
    shell:
        """
            bowtie2 \
            -x {params.bt2_index}\
...
rule bam_stats_spikeIn:
    ...
    output:
        protected("{assayType}/bowtie2/{spikein_version}/{runID}/{library}.spikeIn.bam.stats.txt")
    shell:
        """
...
rule bam_quality_filter_spikeIn:
    ...
    input:
        rules.bowtie2_pe_spikeIn.output
    output:
        temp("{assayType}/samtools/quality_filtered/{spikein_version}/{runID}/{library}.spikeIn.bam")
    shell:
...
rule bam_sort_spikeIn:
    ...
    output:
        temp("{assayType}/samtools/sorted/{spikein_version}/{runID}/{library}.spikeIn.bam")
    shell:
...
rule bam_mark_duplicates_spikeIn:
    ...
    output:
        out = temp("{assayType}/picardTools/MarkDuplicates/{spikein_version}/{runID}/{library}.spikeIn.bam"),
        metrics = protected("{assayType}/picardTools/MarkDuplicates/{spikein_version}/{runID}/{library}.spikeIn.metrics.txt")
    shell:
        """
...
rule bam_rmdup_spikeIn:
    ...
    output:
        temp("{assayType}/samtools/rmdup/{spikein_version}/{runID}/{library}.spikeIn.bam")
    shell:
...
rule bam_index_spikeIn:
    ...
    output:
        protected("{assayType}/samtools/rmdup/{spikein_version}/{runID}/{library}.spikeIn.bam.bai")
    shell:
